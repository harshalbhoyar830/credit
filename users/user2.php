   ...
   <form action="user2.php" method="post">
        <div class="form-group">
          <div>
            ...
            <input class="form-control" type="text" name="user" value="<?php echo $user2['username'] ?>" placeholder="<?php echo $user2['username']; ?>" disabled> <br/>
            <label for="email" class="form-control">Email:</label>
            <input class="form-control" type="text" name="email" value="<?php echo $user2['email']; ?>" placeholder="<?php echo $user2['email']; ?>" disabled><br/>
            <label for="currentcredit" class="form-control">Current Credit:</label>
            <input type="text" name="currentcredit" value="<?php echo $user2['credit']; ?>" class="form-control" placeholder="<?php echo $user2['credit']; ?>" disabled><br/>
            <label for="transfer" class="form-control">How much credit you want to transfer from <?php echo $user2['username']; ?>?</label>
...
<?php
    ...
    if (isset($_POST['transfer'])) {
      ...
      if ($t < $_POST['credit']) {
        ...
        $x = " UPDATE `users` SET `credit`= $transfered WHERE `username` = 'user2' ";
